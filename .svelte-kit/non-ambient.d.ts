...
declare module "$app/types" {
	...
	export interface AppTypes {
		...
		Asset(): "/.DS_Store" | "/apple-touch-icon-precomposed.png" | "/favicon-96x96.png" | "/favicon.ico" | "/favicon.svg" | "/images/.DS_Store" | "/images/logo.png" | "/og-image.png" | "/robots.txt" | "/site.webmanifest" | "/sitemap.xml" | "/web-app-manifest-192x192.png" | "/web-app-manifest-512x512.png" | string & {};
	}
}