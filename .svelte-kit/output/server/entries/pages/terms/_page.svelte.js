...
function _page($$renderer) {
  $$renderer.push(`<main class="container py-5"><h1>Terms of Service</h1> <p>Welcome to <strong>${escape_html(siteConfig.siteName)}</strong>. This website is an <strong>academic demo project</strong> for learning purposes only. No real bookings
